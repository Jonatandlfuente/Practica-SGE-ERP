...
public class PanelGeneralVentas extends JPanel {

	private JScrollPane scrollPaneles;
	private AnadirVenta aVenta = new AnadirVenta();
	private ModificarVenta mVenta = new ModificarVenta();
	private ConsultarVentas cVenta = new ConsultarVentas();
	...
	public PanelGeneralVentas() {
		...
		btnAnadir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				scrollPaneles.setViewportView(aVenta);
				hacerInvisible();
			}
		});
		...
		btnModificar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				scrollPaneles.setViewportView(mVenta);
				hacerInvisible();
		...
		btnConsultar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				scrollPaneles.setViewportView(cVenta);
				hacerInvisible();
			}
		});
