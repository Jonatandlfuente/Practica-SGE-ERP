...
public class PanelGeneralClientes extends JPanel {

	private JScrollPane scrollPaneles;
	private AnadirCliente aCliente = new AnadirCliente();
	private ModificarCliente mCliente = new ModificarCliente();
	private ConsultarCliente cCliente = new ConsultarCliente();
	...
	public PanelGeneralClientes() {
		...
		btnAnadir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				scrollPaneles.setViewportView(aCliente);
				hacerInvisible();
			}
		});
		...
		btnModificar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				scrollPaneles.setViewportView(mCliente);
				hacerInvisible();
		...
		btnConsultar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				scrollPaneles.setViewportView(cCliente);
				hacerInvisible();
			}
		});
