...
public class ModificarCompra extends JPanel {
	...
	private JList list; 
	private JLabel lblNewLabel, lblNewLabel_1, lblFechaSolicitado, lblEstado, lblFechaEntrega, lblFechaRequerido, lblFechaAnulado, lblValor, label, lblIdCompra;
	private JButton btnAadirCompra, button;
	private JComboBox comboBox, cmbComprasid;
	...
	public ModificarCompra() {
		...
		lblNewLabel = new JLabel("Modificar Compras");
		...
		lblIdCompra = new JLabel("Id_Compra");
