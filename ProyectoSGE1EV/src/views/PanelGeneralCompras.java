...
public class PanelGeneralCompras extends JPanel {

	private JScrollPane scrollPaneles;
	private AnadirCompra aCompra = new AnadirCompra();
	private ModificarCompra mCompra = new ModificarCompra();
	private ConsultarCompras cCompra = new ConsultarCompras();
	...
	public PanelGeneralCompras() {
		...
		btnAnadir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				scrollPaneles.setViewportView(aCompra);
				hacerInvisible();
			}
		});
		...
		btnModificar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				scrollPaneles.setViewportView(mCompra);
				hacerInvisible();
		...
		btnConsultar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				scrollPaneles.setViewportView(cCompra);
				hacerInvisible();
			}
		});
