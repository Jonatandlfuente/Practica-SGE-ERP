...
public class ModificarProveedor extends JPanel {
	...
	private JButton button, btnAñadirProv;
	...
	public ModificarProveedor() {
		...
		lblNewLabel = new JLabel("Modificar Proveedores");
		lblNewLabel.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblNewLabel.setBounds(581, 13, 180, 16);
		...
		btnAñadirProv = new JButton("Modificar Proveedor");
	...
	public void hacerInvisible() {
		...
		btnAñadirProv.setVisible(false);
