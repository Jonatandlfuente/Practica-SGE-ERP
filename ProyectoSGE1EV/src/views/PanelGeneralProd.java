...
public class PanelGeneralProd extends JPanel {

	private JScrollPane scrollPaneles;
	private AnadirProducto aProd = new AnadirProducto();
	private ModificarProducto mProd = new ModificarProducto();
	private ConsultarProducto cProd = new ConsultarProducto();
	...
	public PanelGeneralProd() {
		...
		btnAnadir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				scrollPaneles.setViewportView(aProd);
				hacerInvisible();
			}
		});
		...
		btnModificar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				scrollPaneles.setViewportView(mProd);
				hacerInvisible();
		...
		btnConsultar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				scrollPaneles.setViewportView(cProd);
				hacerInvisible();
			}
		});
